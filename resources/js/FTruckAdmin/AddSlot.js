            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 3 }} style={{marginTop: "50px"}}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        ...
                        <Tab icon={<AddLocationIcon />} {...a11yProps(0)} style={{outline: 'none'}}/>
                        <Tab icon={<LocalShippingIcon />} {...a11yProps(1)} style={{outline: 'none'}}/>
                        </Tabs>
                    </Box>
                    <TabPanel value={value} index={0}>
                        <div className="container py-5">
                            ...
                            {error && (
                                <div className="alert alert-warning" role="alert" style={{marginTop: "64px"}}>
                                    {error}
                                </div>
                            )}
                        </div>
                                                ...
                                                <tr key={slot.id}>
                                                    ...
                                                    <td style={{
                                                        ...
                                                        <button
                                                            ...
                                                            data-key={slot.id}
                                                        >
                                                            <DeleteIcon style={{fontSize: "20px", color: "darkred"}}/>
                                                        </button>
                                                    </td>
                                                </tr>
                                            )) 
